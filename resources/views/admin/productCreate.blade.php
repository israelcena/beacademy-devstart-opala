...
<section class="get-in-touch">
  ...
  <form class="contact-form row" action="{{route('products.store')}}" method="POST">
    ...
    <div class="form-field col-lg-6 ">
      <input id="value" name="value" class="input-text js-input" type="text">
      <label class="label" for="value">Valor</label>
    </div>
    <div class="form-field col-lg-6 ">
      <input id="photo" name="photo" class="input-text js-input" type="text">
      <label class="label" for="photo">Link imagem produto</label>
    </div>
    <div class="form-field col-lg-6 ">
      <input id="quantity" name="quantity" class="input-text js-input" type="text">
    ...
    <div class="form-field col-lg-12">
      ...
      <button type="submit" class="submit-btn">Incluir</button>
      <a class="submit-btn" role="button" aria-pressed="true" href="/admin/produtos">Voltar</a>

      <input class="submit-btn" type="submit" value="Incluir">
      <a href="/admin/produtos"><input class="submit-btn" type="submit" value="Voltar"></a>
    </div>
  </form>
</section>
