...
<section class="get-in-touch">
  ...
  <form class="contact-form row" action="{{route('admin.products.store')}}" method="POST">
    ...
    <div class="form-field col-lg-6 ">
      <input id="value" name="value" class="input-text js-input" type="number" step="0.01" min="0" required>
      <label class="label" for="value">Valor</label>
    </div>
    <div class="form-field col-lg-6 ">
      <input id="photo" name="photo" class="input-text js-input" type="text" required>
    ...
    <div class="form-field col-lg-12 d-grid gap-2 d-md-flex justify-content-md-end">
      ...
      <a class="submit-btn text-center" href="/admin/produtos" style="text-decoration: none">Voltar</a>
    </div>
  </form>
</section>
